...
void modificar(){
	...
	switch(op2){
		case 1:
			system("cls");
			printf("Ingrese las siglas de la CriptoMoneda: \n");
			gets(cmp);
			fflush (stdin);
			for(int i=0;1<=cont;i++){
				system("cls");
				if(strcmp(moneda[i].siglas,cmp)==0){
					system("cls");
					printf("\nNombre de la moneda: %s", moneda[i].nombre);
					printf("\nSiglas de la moneda: %s", moneda[i].siglas);
					printf("\nValor de la moneda: %s", moneda[i].valor);
					
					system("cls");
					printf("Ingrese un nuevo nombre: \n");
					gets(moneda[i].nombre);
					printf("Ingrese las siglas: \n");
					gets(moneda[i].siglas);
			...
			case 2:
				system("cls");
				printf("Ingrese el nombre de la Criptomneda: \n");
				gets(cmp);
				fflush (stdin);
				for(int j=0;j<=cont;j++){
					system("cls");
					if(strcmp(moneda[j].siglas,cmp)==0){
						system("cls");
						printf("\nNombre de la moneda: ",moneda[j].nombre);
						printf("\nSiglas de la criptomoneda: ",moneda[j].siglas);
						printf("\nValor de la Criptomoneda: ", moneda[j].valor);
						
						system("cls");
						printf("Ingrese un nuevo nombre: \n");
					    gets(moneda[j].nombre);
					    printf("Ingrese las siglas: \n");
					    gets(moneda[j].siglas);
					    printf("Ingrese el valor: \n");
					    gets(moneda[j].valor);
